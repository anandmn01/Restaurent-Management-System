...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>My Restaurent Food stop</title>
  <meta name="title" content="Anand - Amazing & Delicious Food">
  <meta name="description" content="This is a Restaurant html template made by Anand Kumar">
...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Restaurant Near delhi by pass Rohtak,India
        </span>
      </address>
      ...
      <a href="tel:+91-7870489187" class="topbar-item link">
        <div class="icon">
          <ion-icon name="call-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">+91-7091505216</span>
      </a>
      ...
      <a href="mailto:booking@restaurant.com" class="topbar-item link">
        ...
        <span class="span">anandkumar01.2020@gmail.com.com</span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo.svg" width="160" height="50" alt="Anand - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="text-center">
          ...
          <address class="body-4">
            Restaurant at, Delhi by pass, <br>
            Rohtak, India
          </address>

          <p class="body-4 navbar-text">Open: 9.30 am - 2.30pm</p>

          <a href="mailto:booking@grilli.com" class="body-4 sidebar-link">anandkumar01.2020@gmail.com</a>
    ...
    <article>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <div class="wrapper">
              <del class="del body-3">Price.400.0</del>

              <span class="span body-1">Price.200.0</span>
            </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Price.255.0</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Price.400.0</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Price.100.00</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Price.390.0</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Price.250.0</span>
                  </div>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <div class="profile">
            <img src="./assets/images/myphoto.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">

            <p class="label-2 profile-name">Anand Kumar</p>
          </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+91-7091505216" class="link">+91-7091505216</a>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+88123123456" class="body-1 contact-number hover-underline">+91-7091505216</a>
              ...
              <address class="body-4">
                Restaurant , Near delhi by pass, <br>
              Rohtak,India
              </address>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-15">29/04/2023</time>
                </div>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-08">04/05/2023</time>
                </div>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2022-09-03">03/05/2023</time>
                </div>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <address class="body-4">
            Restaurant , Near delhi by pass, Rohtak 124001,India
          </address>

          <a href="mailto:booking@abc.com" class="body-4 contact-link">anandkumar01.2020@gmail.com</a>

          <a href="tel:+88123123456" class="body-4 contact-link">Booking Request : +91-7091505216</a>
